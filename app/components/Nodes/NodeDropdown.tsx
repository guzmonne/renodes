...
export function NodeDropdown({
  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger as={NodeControl} icon={"fa-ellipsis-v"} />
      <DropdownMenu.Content className="DropdownMenu__Content" sideOffset={5}>
        ...
        <DropdownMenu.Item className="DropdownMenu__Item" onSelect={onEdit ? onEdit : VOID}>
          <div className="DropdownMenu__LeftSlot">{isInEditMode ? <i className="fas fa-save" /> : <i className="fas fa-pencil" />}</div>
